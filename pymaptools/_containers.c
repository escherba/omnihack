 ...
 */
  ...
  __Pyx_GOTREF(__pyx_v_self->_mapping);
  __Pyx_DECREF(__pyx_v_self->_mapping);
  __pyx_v_self->_mapping = __pyx_t_1;
  __pyx_t_1 = 0;
...
static PyObject *__pyx_tp_new_10pymaptools_11_containers_OrderedSet(PyTypeObject *t, PyObject *a, PyObject *k) {
  ...
  p->_mapping = Py_None; Py_INCREF(Py_None);
...
static int __pyx_tp_traverse_10pymaptools_11_containers_OrderedSet(PyObject *o, visitproc v, void *a) {
  ...
  if (p->_mapping) {
    e = (*v)(p->_mapping, a); if (e) return e;
  }
  if (p->_maxlen) {
